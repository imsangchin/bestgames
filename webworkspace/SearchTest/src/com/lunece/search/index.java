...
public class index  {
    ...
    public void createIndex() throws IOException{
        //数据存放文件夹
        File  f_doc=new File("/Users/huwei/webworkspace/SearchTest/data");
        //索引存放文件夹
        File  f_idx=new File("/Users/huwei/webworkspace/SearchTest/index2");
    ...
    {
        //创建一个IndexSearcher
        File  f=new File("/Users/huwei/webworkspace/SearchTest/index2");
        ...
        QueryParser parser=new QueryParser(Version.LUCENE_44,"body",analyzer);
