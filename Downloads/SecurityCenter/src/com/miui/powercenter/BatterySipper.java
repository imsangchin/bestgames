...
public class BatterySipper implements Comparable<BatterySipper> {
    ...
    BatterySipper(Context context, ArrayList<BatterySipper> requestQueue,
        ...
        if (iconId > 0) {
            icon = IconCustomizer.generateIconStyleDrawable(
        ...
        if ((label == null || iconId == 0) && uid != null) {
            getQuickNameIconForUid(context, uid);
        }
        uidObj = uid;
    }
    ...
    void getQuickNameIconForUid(Context context, Uid uidObj) {
    ...
    void getNameIcon() {
        ...
        mHandler.sendMessage(mHandler.obtainMessage(PowerRankHelper.MSG_UPDATE_NAME_ICON, this));
    }
}
