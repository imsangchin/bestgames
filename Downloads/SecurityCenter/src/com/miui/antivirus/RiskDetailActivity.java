...
public class RiskDetailActivity extends Activity implements OnClickListener {
    ...
    private TextView mRiskNameView;
    private TextView mRiskDescxView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.v_activity_risk_detail);
        ...
        mRiskNameView = (TextView) findViewById(R.id.risk_name);
        mRiskDescxView = (TextView) findViewById(R.id.risk_descx);
        ...
        mRiskNameView.setText(mData.getVirusName());
        mRiskDescxView.setText(mData.getVirusDescx());
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.clear) {
            VirusCheckManager.getInstance(getApplicationContext()).removeRisk(mData);
