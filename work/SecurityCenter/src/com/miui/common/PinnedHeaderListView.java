...
public class PinnedHeaderListView extends ListView implements OnScrollListener {
    ...
    public static interface PinnedSectionHeaderAdapter {
    ...
    private PinnedSectionHeaderAdapter mAdapter;
    ...
    public void setAdapter(ListAdapter adapter) {
        mCurrentHeader = null;
        mAdapter = (PinnedSectionHeaderAdapter) adapter;
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
        ...
        mCurrentHeader = getSectionHeaderView(section, mCurrentHeaderViewType != viewType ? null
                : mCurrentHeader);
    ...
    public static abstract class OnItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public abstract void onItemClick(AdapterView<?> adapterView, View view, int section,
                int position, long id);

        public abstract void onSectionClick(AdapterView<?> adapterView, View view, int section,
                long id);
