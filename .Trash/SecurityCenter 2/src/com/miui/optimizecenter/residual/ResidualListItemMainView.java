...
public class ResidualListItemMainView extends LinearLayout implements BindableView<ResidualModel>,
        OnCheckedChangeListener, ListItemExpandListener, ListItemCollapseListener, OnClickListener {
    private EventHandler mEventHandler;
    private ResidualModel mModel;
    ...
    public ResidualListItemMainView(Context context) {
        this(context, null);
    }

    public ResidualListItemMainView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
