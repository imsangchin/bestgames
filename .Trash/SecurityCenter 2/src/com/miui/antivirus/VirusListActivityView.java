...
import com.miui.antivirus.VirusListActivity.VirusListAdapter;
...
public class VirusListActivityView extends RelativeLayout implements OnClickListener {
    ...
    public VirusListActivityView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VirusListActivityView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        mVirusListView = (ListView) findViewById(R.id.virus_list);
    }
    ...
    public void setVirusListAdapter(VirusListAdapter adapter) {
